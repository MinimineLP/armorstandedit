...
BookPage pose_page = BookPage([TextComponent(" "),
  ...
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(33)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(34)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(35)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(36)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(37)),
  TextComponent("\n"),
  ...
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(39)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(40)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(41)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(42)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(43)),
  TextComponent("\n"),
  ...
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(45)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(46)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(47)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(48)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(49)),
  TextComponent("\n"),
  ...
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(51)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(52)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(53)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(54)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(55)),
  TextComponent("\n"),
  ...
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(57)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(58)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(59)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(60)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(61)),
  TextComponent("\n"),
  ...
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(63)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(64)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(65)),
  TextComponent("  "),
  TextComponent("-", color: Color.Red, clickEvent: trigger(66)),
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(67)),
  TextComponent("\n"),
  ...
  TextComponent(" "),
  TextComponent("+", color: Color.DarkGreen, clickEvent: trigger(69)),
  TextComponent("\n\n"),
  ...
  TextComponent("   "),
  TextComponent("+1", color: Color.DarkGreen, clickEvent: trigger(73)),
  TextComponent(" "),
  TextComponent("+5", color: Color.DarkGreen, clickEvent: trigger(74)),
  TextComponent(" "),
  TextComponent("+15", color: Color.DarkGreen, clickEvent: trigger(75)),
